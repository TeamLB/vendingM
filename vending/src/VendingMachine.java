...
//datahandler
    ...
    JLabel product1des = new JLabel("호로요이1", JLabel.CENTER);  //Mars Bar
    ...
    JLabel product2des = new JLabel("호로요이2", JLabel.CENTER); //Bounty Bar Original
    ...
    JLabel product3des = new JLabel("호로요이3", JLabel.CENTER); //Twix Double Bar
    ...
    JLabel product4des = new JLabel("호로요이4", JLabel.CENTER); //Walker's Ready Salted
    ...
    JLabel product5des = new JLabel("호로요이5", JLabel.CENTER);  //Monster Munch -
    ...
    JLabel product6des = new JLabel("호로요이6", JLabel.CENTER); //Walkers Sensations -
    ...
    JLabel product7des = new JLabel("호로요이7", JLabel.CENTER); //Coca-Cola (330ml)
    ...
    JLabel product8des = new JLabel("호로요이8", JLabel.CENTER); //Dr Pepper (330ml)
    ...
    JLabel product9des = new JLabel("호로요이9", JLabel.CENTER); //Fruit Pastels
    ...
    JLabel product10des = new JLabel("호로요이10", JLabel.CENTER); //Wine Gums
...
//5 pence
    ImageIcon fivePenceImage = new ImageIcon("C:\\Users\\LEESIYOUNG\\workspace\\vending\\src\\images\\b1.jpg");
    JButton fivePenceButton = new JButton("", fivePenceImage);
    //10 pence
    ImageIcon tenPenceImage = new ImageIcon("C:\\Users\\LEESIYOUNG\\workspace\\vending\\src\\images\\b2.jpg");
    JButton tenPenceButton = new JButton("", tenPenceImage);
    //20 pence
    ImageIcon twentyPenceImage = new ImageIcon("C:\\Users\\LEESIYOUNG\\workspace\\vending\\src\\images\\b3.jpg");
    JButton twentyPenceButton = new JButton("", twentyPenceImage);
    //50 pence
    ImageIcon fiftyPenceImage = new ImageIcon("C:\\Users\\LEESIYOUNG\\workspace\\vending\\src\\images\\b4.jpg");
    JButton fiftyPenceButton = new JButton("", fiftyPenceImage);
    //1 pound
    ImageIcon onePoundImage = new ImageIcon("C:\\Users\\LEESIYOUNG\\workspace\\vending\\src\\images\\b5.jpg");
    JButton onePoundButton = new JButton("", onePoundImage);
    //2 pound
    ImageIcon twoPoundImage = new ImageIcon("C:\\Users\\LEESIYOUNG\\workspace\\vending\\src\\images\\b6.jpg");
...
//calculation stuff:
    int productTotal = 0;//holds value for total to be inserted (total price of all selected items)
    int totalInserted = 0;//holds value for total money put in
...
//close btn
        CFclose.setBounds(145,320,500,25);
...
//adds the text string the the selected items text field
            addToSelection = selectedItems.getText() + "\n Walker's Ready Salted Crisps - ?0.55";
            selectedItems.setText(addToSelection);
...
//adds the text string the the selected items text field
            addToSelection = selectedItems.getText() + "\n Monster Munch - Pickled Onion - ?0.70";
            selectedItems.setText(addToSelection);
...
//adds the text string the the selected items text field
            addToSelection = selectedItems.getText() + "\n Walkers Sensations - Thai Sweet Chilli - ?1.10";
            selectedItems.setText(addToSelection);
...
//gets value of change remaining
            ...
            {
                CFoutputMessage.setText(" Error!\n\nYou still have ?"
                        + decFormat.format(calcChange) + " in change to take!");
                CFoutputMessage.setBackground(Color.red);
            }
            if (calcChange == 0)
            {
