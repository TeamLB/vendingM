    ...
    */
    public VendingMachineDBHandler()
    {
        ...
        try {
            ...
            Connection order = DriverManager.getConnection("jdbc:mysql://jycom.asuscomm.com:5066/vending?useSSL=true&verifyServerCertificate=false", "root","Cent12!@");
